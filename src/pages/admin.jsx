...
import { getCategories, createCategory, deleteCategory, getBlogs, createBlog, updateBlog, deleteBlog } from '../services/api';
...
export default function AdminPanel() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setCategories(prev => [...prev, data.category].sort((a, b) => 
                      ...
                      <tr key={blog._id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4">
                          <div className="flex gap-2">
                            ...
                            <button
                              onClick={() => openDeleteBlogModal(blog._id, blog.title)}
                              className="text-red-600 hover:text-red-800 transition-colors"
                              title="Delete blog"
                            >
                              <Trash2 size={18} />
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto pointer-events-auto">
            ...
            <form onSubmit={handleBlogUpdate} className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Image {!imageFile && <span className="text-gray-500 font-normal">(Keep existing or upload new)</span>}
                </label>
