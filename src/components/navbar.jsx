      ...
      <div className="bg-[#1a1a1a] text-white text-sm">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="text-gray-300 hover:text-red-400 transition-colors">Documentation</a>
            <span className="text-gray-500">|</span>
            <a href="#" className="text-gray-300 hover:text-red-400 transition-colors">Buy It Now</a>
              ...
              {socialIcons.map((social, index) => (
                ...
                >
                  {social.brand === 'linkedin' ? (
                    <LinkedinIcon size={16} className="text-red-300" />
                  ) : (
                    <img
      ...
      <div className="bg-[#b91c1c] text-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <button className="p-3 hover:bg-black transition-colors" aria-label="Search">
              <Search size={20} />
            </button>
          </div>
        </div>
